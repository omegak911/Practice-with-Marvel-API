...
var _MainDisplay = __webpack_require__(29);

var _MainDisplay2 = _interopRequireDefault(_MainDisplay);

var _InventoryList = __webpack_require__(57);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.addNewCharacter = _this.addNewCharacter.bind(_this);
    _this.requestCharacterFromServer = _this.requestCharacterFromServer.bind(_this);
    _this.searchInventory = _this.searchInventory.bind(_this);
  ...
  _createClass(App, [{
    key: 'addNewCharacter',
    value: function addNewCharacter(characterInfo) {
      _axios2.default.post('/addNewCharacter', characterInfo).then(function (result) {
        console.log(result);
      }).catch(function (err) {
        console.log(err);
      });
    ...
    key: 'searchInventory',
    value: function searchInventory(query) {
      var _this2 = this;

      console.log('Query is: ', query);
      var found = false;
      this.state.inventory.forEach(function (character) {
        if (character.name === query) {
          _this2.setState({ displayCharacter: character });
          found = true;
        }
      });
    ...
    key: 'requestCharacterFromServer',
    value: function requestCharacterFromServer(query) {
      var _this3 = this;

      var context = this;
      _axios2.default.get('/findCharacterInDB', { params: { name: query } }).then(function (_ref) {
        var data = _ref.data;

        console.log(data);
        context.setState({ inventory: [].concat(_toConsumableArray(_this3.state.inventory), _toConsumableArray(data)) });
      }).catch(function (err) {
        console.log(err);
      });
    }
    ...
    value: function login(params) {
      _axios2.default.get('/login', params).then(function (res) {
        console.log(res);
        // if (res === '404') {
    ...
    value: function render() {
      var _state = this.state,
          displayCharacter = _state.displayCharacter,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('br', null),
        _react2.default.createElement(_MainDisplay2.default, { addNewCharacter: this.addNewCharacter, searchInventory: this.searchInventory }),
        _react2.default.createElement('br', null),
        _react2.default.createElement(_InventoryList2.default, { inventory: inventory })
      );
    }
  }]);
...
var Login = function Login(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'button',
        { type: 'button', onClick: keyHandler },
        'Submit'
      )
    )
  );
...
var MainDisplay = function MainDisplay(_ref) {
  var addNewCharacter = _ref.addNewCharacter,
      searchInventory = _ref.searchInventory;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'form',
      null,
      _react2.default.createElement('input', { id: 'charName', type: 'text' }),
      ' Character Name',
      _react2.default.createElement('br', null),
      _react2.default.createElement('input', { id: 'description', type: 'text' }),
      ' Description',
      _react2.default.createElement('br', null),
      _react2.default.createElement('input', { id: 'urls', type: 'text' }),
      ' urls',
      _react2.default.createElement('br', null),
      _react2.default.createElement('input', { id: 'thumbnail', type: 'text' }),
      ' picture',
      _react2.default.createElement('br', null),
      _react2.default.createElement('input', { id: 'comics', type: 'text' }),
      ' comic appearances',
      _react2.default.createElement('br', null),
      _react2.default.createElement('input', { id: 'series', type: 'text' }),
      ' series',
      _react2.default.createElement(
        'button',
...
var Inventory = function Inventory(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement("img", { className: "thumbnails", src: character.thumbnail }),
    _react2.default.createElement("br", null),
    character.name
  );
};
...
var _Inventory = __webpack_require__(30);
...
var InventoryList = function InventoryList(_ref) {
  ...
  return _react2.default.createElement(
    ...
    inventory.map(function (character) {
      return _react2.default.createElement(_Inventory2.default, { character: character });
    })
  );
};
